...
process CTAT {
	...
	output:
		tuple val(samples), file ("${samples}_ctat-LR.fusion_predictions.tsv"), emit: ctat_out
	...
	cp ctat_LR_fusion_outdir/ctat-LR-fusion.fusion_predictions.abridged.tsv ${samples}_ctat-LR.fusion_predictions.tsv
